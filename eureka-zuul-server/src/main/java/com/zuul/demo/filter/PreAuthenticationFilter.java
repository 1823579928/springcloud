...
public class PreAuthenticationFilter extends ZuulFilter {
    public static final String TOKEN_ENDPOINT = "/api/auth/oauth/token";
    public static final String TOKEN_KEY_ENDPOINT = "/api/auth/oauth/token_key";
    public static final String CHECK_TOKEN_ENDPOINT = "/api/auth/oauth/check_token";
    public static final String OAUTH_AUTHORIZE = "/api/auth/oauth/authorize";
